...
public class Level_Tutorial5 : MonoBehaviour, EnemyLevel
{
    public static Level_Tutorial5 Level_Tutorial5Reference;
    ...
    private void Awake()
    {
        ...
        if (Level_Tutorial5Reference == null)
        {
            Level_Tutorial5Reference = this;
        }
        else
        {
        }
    ...
    void Start()
    {
        DungeonMaster.dm.setCurrentSceneReference(Level_Tutorial5Reference);
